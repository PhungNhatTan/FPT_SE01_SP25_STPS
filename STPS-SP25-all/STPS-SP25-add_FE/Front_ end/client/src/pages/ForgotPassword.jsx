...
// hàm send mail để đổi pass
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch("https://localhost:7083/api/SendMailAPI/sendOtpToEmail", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        setError("Không thể gửi New password. Vui lòng thử lại.");
        return;
      }

      setSuccessMessage("New password sent successfully");
      setTimeout(() => {
